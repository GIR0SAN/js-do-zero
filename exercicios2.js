...
const frutas = {
 ...
 const fruta = ['banana', 'maça', 'pera', 'uva']
...
banda.genero=['Hard rock', 'Blues', 
    'Rock-folk', 'Rock' , 'Heavy Metal']
...
const primeiroCharacterUrl = pokemon.moves[0].versionGroupDetails[1].versionGroup.url[0]
...
console.log(`Nesta bateria de exercícios vimos que marca armazena um array no qual o segundo item é ${marcas[1]}, um dos gêneros da banda ${banda.nome} é ${banda.genero[3]} e que a propriedade moveLearnMethod do Articuno contém um objeto com uma propriedade name que armazena "machine".`)